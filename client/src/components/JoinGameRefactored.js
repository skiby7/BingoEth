...
const InputSection = ({ gameId, re, setGameId, randomGame, loading, getInfoGame, setView }) => (
    <div className="grid grid-cols-1 gap-4">
        {!randomGame && (
            <input
                value={gameId}
...
const GameInfo = ({ gameId, ethBet, maxJoiners, totalJoiners, loading, joinGame, setInfoFetched }) => (
    <div>
